...
import {RFPercentage, RFValue} from 'react-native-responsive-fontsize';
  ...
  class MainSettingScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fontLoaded:false,
      ...
      <Container>
        ...
        <View style={styles.container}>
           ...
           <View>
             ...
             onPress={() => this.props.navigation.navigate('friendssettingscreen')}>
               <Text
               style={{
                fontSize:RFValue(15),
                fontWeight:'400',
           ...
           <View>
             ...
             onPress={() => this.props.navigation.navigate('privacysettingscreen')}>
               <Text
               style={{
                fontSize:RFValue(15),
                fontWeight:'400',
...
class FriendsSettingScreen extends Component {
  constructor(props) {
      super(props);
      this.state = {
          fontLoaded:false,
...
const SettingScreen = createStackNavigator(
  {
    Mainsettingscreen: {
      screen: MainSettingScreen,
      navigationOptions: {
        header:null
      }
    },
    friendssettingscreen: {
      screen: FriendsSettingScreen,
      navigationOptions: {
        header:null
      }
    },
...
export default createAppContainer(SettingScreen);
